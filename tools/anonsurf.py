...
class AnonymouslySurf(HackingTool):
    ...
    INSTALL_COMMANDS = [
        "sudo git clone https://github.com/Flutter13264-r/PULSE/tree/main/tools/kali-anonsurf.git",
        "cd kali-anonsurf && sudo ./installer.sh && cd .. && sudo rm -r kali-anonsurf"
    ]
    RUN_COMMANDS = ["sudo anonsurf start"]
    PROJECT_URL = "https://github.com/Flutter13264-r/PULSE/tree/main/tools/kali-anonsurf"
...
class Multitor(HackingTool):
    ...
    INSTALL_COMMANDS = [
        "sudo git clone https://github.com/Flutter13264-r/PULSE/tree/main/tools/multitor.git",
    ...
    PROJECT_URL = "https://github.com/Flutter13264-r/PULSE/tree/main/tools/multitor"
